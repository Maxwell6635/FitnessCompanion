...
import my.com.saiboon.fitnesscompanion.UI.SchedulePage;

/**
 * Created by saiboon on 25/7/2015.
 */
public class CustomAdapterSchedule extends BaseAdapter implements View.OnClickListener {
    ...
    public CustomAdapterSchedule(Activity a, ArrayList d,Resources resLocal) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            vi = inflater.inflate(R.layout.schedule_tabitem, null);
            ...
            holder.myToggleButton = (ToggleButton) vi.findViewById(R.id.myToggleButton);
