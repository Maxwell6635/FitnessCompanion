...
public class ExercisePage extends ActionBarActivity implements SensorEventListener {
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                mConnected = true;
                Toast.makeText(ExercisePage.this,"Heart Rate Sensor connected",Toast.LENGTH_SHORT).show();
                invalidateOptionsMenu();
            } else if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
                mConnected = false;
                Toast.makeText(ExercisePage.this,"Heart Rate Sensor disconnected",Toast.LENGTH_SHORT).show();
                invalidateOptionsMenu();
                mBluetoothLeService.connect(mDeviceAddress);
